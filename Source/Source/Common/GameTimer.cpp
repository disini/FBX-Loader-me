  ...
  mPausedTime(0), mPrevTime(0), mCurrTime(0), mStopped(false)
{
	...
	QueryPerformanceFrequency((LARGE_INTEGER*)&countsPerSec);// 10000000, 寧푤拱， 쑹똑0.1菓취
	mSecondsPerCount = 1.0 / (double)countsPerSec;// 쑹똑0.1菓취
}
...
void GameTimer::Tick()
{
	...
	mDeltaTime = (mCurrTime - mPrevTime)*mSecondsPerCount;// 데貫槨s
