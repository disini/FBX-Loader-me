...
void Textures::BuildCBVTex2D(const int offset)
{
	...
	for (auto& e : mOrderTexture)
	{
		//if (e->Filename == L"D:\\Dev\\Developing\\DirectX\\CharacterTool\\Resource\\FBX\\Character\\Idle.fbm/Kachujin_diffuse.png")
		if (e->Filename.find(L"D:") != e->Filename.npos)
		{
			printf("Absolute Path found!");
			e->Filename = L"A";
		}
		vTex.push_back(e->Resource);// +		Filename	L"D:\\Dev\\Developing\\DirectX\\CharacterTool\\Resource\\FBX\\Character\\Idle.fbm/Kachujin_diffuse.png"	std::wstring
	}
	// NULL
